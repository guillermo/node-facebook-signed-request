...
SignedRequest.prototype.extractRequestSignature = function(cb){
  try {
    this.signature = SignedRequest.base64UrlDecode(this.encodedSignature);
  }
  catch (e) {
...
SignedRequest.prototype.parseRequestPayload = function(cb){
  try {
    ...
    console.log('invalid JSON', this.payload);
...
SignedRequest.prototype.computeSignature = function(cb){
  ...
  this.computedSignature = SignedRequest.base64UrlDecode(shasum.digest('base64'));
  cb();
};
